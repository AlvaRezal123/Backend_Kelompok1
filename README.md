...
<h2>2. Kedua 🗳️</h2>
Langkah Kedua kita akan menginstall Framework CodeIgniter Versi 4. CodeIgniter adalah framework PHP berbasis MVC (Model-View-Controller) yang memudahkan dalam pengembangan aplikasi web dengan cara yang lebih terorganisir, aman, dan cepat. untuk penginstalan bisa dilakukan di Website dengan link (https://codeigniter.com/download), jika sudah di download jangan lupa di ekstrak lalu masukan file CI4 tersebut ke folder (laragon -> www).
...
<h2>11. Kesebelas ⚠️</h2> TIPS Debugging
